...
<body>
    ...
    <form name="form" method="post" enctype="multipart/form-data" class="form-register">
        <div class="content">
            <div class="header">
            <h2>Crear un Saber Ancestral</h2> 
            </div>
            <br>
            <div class="body">
                ...
                <br>
                <textarea type="text" name="descripcion" rows="4" class="form-control required" required></textarea>
                </div>

                <div class="form-group">
                <label class="form-label required">Elija la Nacionalidad o Pueblo:</label>
                <br>
                <select id="cultura" class="form-control required" name="cultura">
                ...
                <br>
                <input type="file" id="my_file" name="my_file" class="form-control required" required>
                </div>
            ...
            <div class="footer">
				...
				<input type="submit" name="guardar" value="GUARDAR" class="btn btn-success guardar">
            </div>
        </div>
    </form>
    </section>
